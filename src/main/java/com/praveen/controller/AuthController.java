...
import com.praveen.model.USER_ROLE;
import com.praveen.model.User;
import com.praveen.repository.CartRepository;
import com.praveen.request.LoginRequest;
import com.praveen.response.AuthResponse;
import com.praveen.service.CustomerUserDetailsService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> createUserHandler(@RequestBody User user) throws Exception {
        ...
        if(isEmailExist != null){
            throw new Exception("Email already exists used by another user");
        }
